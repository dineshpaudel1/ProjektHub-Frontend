                        ...
                        <table className="w-full">
                            <thead className="bg-gray-50">
                                <tr>
                                    ...
                                    <th className="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase">Order Type</th>
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {orders.map((order) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4 text-sm text-gray-900">{order.numberOfItems} items</td>
                                        <td className="px-6 py-4 text-sm font-semibold text-gray-900">NPR {order.totalPrice.toLocaleString()}</td>
                                        <td className="px-6 py-4 text-sm font-semibold text-gray-700">{order.orderType}</td>
                                        <td className="px-6 py-4">

                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="space-y-8">
                        <div className="space-y-6">
                            ...
                            >
                                We use creativity and cutting-edge technology to help students and
                                businesses bring their visions to reality. From final year projects to
                                scalable enterprise platforms, we craft each solution with precision,
                                care, and innovation.
                            </p>
                        </div>

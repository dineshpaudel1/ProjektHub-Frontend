...
const Home = () => {
    ...
    /* ───────── scroll-on-load (retain anchor) ───────── */
    useEffect(() => {
        const targetId =
            location.state?.scrollTo || localStorage.getItem("scrollTo");
        if (targetId) {
    ...
    const handleSectionClick = (sectionId) => {
        if (location.pathname !== "/") {
            // navigate to home first, then scroll (location.state keeps target)
    ...
    return (
        <section
            id="home"
            /* 1️⃣ 80-px top padding on small screens, removed on md+  
               2️⃣ scroll-margin-top so anchor jumps land correctly */
            className="relative min-h-screen flex flex-col justify-center
                 pt-[80px] md:pt-0 scroll-mt-[80px]
                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="text-center lg:text-left space-y-8">
                        ...
                        <div className="space-y-4">
                            <h1
                                className="text-4xl sm:text-5xl lg:text-5xl font-extrabold leading-tight break-words max-w-3xl mx-auto lg:mx-0"
                            ...
                            <p
                                className="text-lg sm:text-lg leading-relaxed max-w-2xl mx-auto lg:mx-0"
                                style={{ color: "var(--text-secondary)" }}>
                                Transform your vision into exceptional digital solutions. We
                                specialize in creating custom-built projects
                            </p>
                        </div>
                    ...
                    <div className="relative flex justify-center lg:justify-end">
                        ...
                        <div className="relative">
                            ...
                            <div
                                className="relative rounded-3xl shadow-2xl p-8 transform hover:scale-105 transition-transform duration-500"

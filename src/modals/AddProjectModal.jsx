...
const AddProjectModal = ({ isOpen, onClose, onCreate, formData, setFormData }) => {
    ...
    return (
        <div className="fixed inset-0 z-30 bg-black/30 backdrop-blur-sm flex items-start justify-center pt-20">
            <div className="bg-white border border-gray-300 rounded-lg shadow-xl p-6 w-full max-w-md z-40">
